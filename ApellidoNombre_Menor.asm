# Código MIPS - Programa 2: Número Menor
# Archivo: ApellidoNombre_Menor.asm

# Programa: Encontrar el número menor
# Archivo: ApellidoNombre_Menor.asm
# Descripción: Programa que encuentra el menor entre 3-5 números
...
main:
    ...
    # Leer primer número como inicial mínimo
    li $v0, 4                    # syscall para imprimir string
    ...
    li $v0, 5                    # syscall para leer entero
    syscall                      # ejecutar syscall
    move $t3, $v0                # $t3 = número mínimo actual
...
leer_numeros:
    ...
    bge $t5, $t3, siguiente      # si número_actual >= mínimo, continuar
    move $t3, $t5                # actualizar mínimo
...
mostrar_resultado:
    ...
    move $a0, $t3                # cargar número menor
    syscall                      # ejecutar syscall
